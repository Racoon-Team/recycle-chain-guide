...
const VideoAreaHomeOne = ({ style_2 }: any) => {
  ...
  return (
    <>
      <div className={`lonyo-section-padding bg-heading  ${style_2 ? '' : 'position-relative sectionn'}`}>
          ...
          <div className="row">
            ...
            <div className="col-lg-7 d-flex align-items-center">
              <div
                ...
                <p>
                  It's a cloud-based accounting tool ideal for individuals & businesses to easily manage finances,
                  invoices & payroll. Unlock the 3-step path to enhanced financial control.{' '}
                </p>
                <div className="mt-50" data-aos="fade-up" data-aos-duration="700">
                  <Link className="lonyo-default-btn video-btn" to="/contact-us">
                    Download the app
                  </Link>
                </div>
              </div>
          ...
          <div className="row">
            <div className="col-xl-4 col-md-6">
              <div className="lonyo-process-wrap" data-aos="fade-up" data-aos-duration="500">
                ...
                <div className="lonyo-process-data">
                  <p>
                    Link your bank, credit card or investment accounts to automatically track transactions and get a
            ...
            <div className="col-xl-4 col-md-6">
              <div className="lonyo-process-wrap" data-aos="fade-up" data-aos-duration="700">
                ...
                <div className="lonyo-process-data">
                  <p>
                    Define your spending limits and savings goals for categories like groceries, bills or future
                    investments to stay on track.
                  </p>
                </div>
              </div>
            </div>
            <div className="col-xl-4 col-md-6">
              <div className="lonyo-process-wrap" data-aos="fade-up" data-aos-duration="900">
                ...
                <div className="lonyo-process-data">
                  <p>
                    Check your financial dashboard for regular updates and set up automatic payments or savings to
                    simplify management.
                  </p>
                </div>
              </div>
