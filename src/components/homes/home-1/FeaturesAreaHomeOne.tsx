...
const FeaturesAreaHomeOne = ({ style_2, style_3 }: any) => {
  ...
  return (
    <>
      ...
      <div
        className={`${style_2 ? 'lonyo-section-padding10' : style_3 ? 'lonyo-section-padding6' : 'lonyo-section-padding2'} position-relative `}>
          ...
          <div className="row">
            {feature_data.map((item, i) => (
              <div key={i} className="col-xl-4 col-lg-6 col-md-6">
                <div className="lonyo-service-wrap light-bg" data-aos="fade-up" data-aos-duration={item.delay}>
