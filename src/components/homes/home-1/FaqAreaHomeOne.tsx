...
const faq_data = [
  ...
  },
  {
    ...
    answer: 'The app offers both free and premium subscription plans with additional features in the paid version.',
  },
];
...
const FaqAreaHomeOne = ({ style_2, style_3, style_4 }: any) => {
  ...
  return (
    <>
      <div
        className={`lonyo-section-padding4 ${style_4 ? 'section' : ''} ${style_2 ? 'section' : style_3 ? 'section pt-0' : ''}`}>
        <div className="container">
          ...
          <div className="faq-btn" data-aos="fade-up" data-aos-duration="700">
            <Link className="lonyo-default-btn faq-btn2" to="/faq">
