...
const FinancialUpdateHomeOne = ({ style_2, style_3 }: any) => {
  ...
  return (
    <>
      <div
        className={`${style_2 ? 'lonyo-section-padding' : style_3 ? 'lonyo-section-padding3 overflow-hidden' : 'lonyo-section-padding4 position-relative'}`}>
        <div className="container">
          <div className="row">
            <div className="col-lg-5 order-lg-2">
              <div
                className={`${style_3 ? 'lonyo-faq-thumb' : 'lonyo-content-thumb'}`}
                data-aos="fade-up"
            ...
            <div className="col-lg-7 d-flex align-items-center">
              <div className="lonyo-default-content pr-50" data-aos="fade-right" data-aos-duration="700">
                ...
                <p className="data">
                  This feature ensures you can easily stay on top of your finances by consolidating all updates into a
                  single dashboard.
                </p>
                <div className="mt-50">
                  <ul className="tabs">
