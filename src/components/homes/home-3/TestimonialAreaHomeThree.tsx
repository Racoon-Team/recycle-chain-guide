          ...
          <div className="row">
            <div className="col-xl-4 col-lg-6">
              <div className="lonyo-rating-wrap pt-0" data-aos="fade-up" data-aos-duration="500">
                ...
                <div className="lonyo-rating-content">
                  <p>
                    “Life-changing tool for budgeting! This app has completely transformed how I manage my money. Highly
                    recommend!”
                  </p>
            ...
            <div className="col-xl-4 col-lg-6">
              <div className="lonyo-rating-wrap pt-24" data-aos="fade-up" data-aos-duration="700">
                ...
                <div className="lonyo-rating-content">
                  <p>
                    “It save money more than I expected! With this software, I can stick to my budget. Goal-setting
                    features are highly motivating!”
                  </p>
            ...
            <div className="col-xl-4 col-lg-6">
              <div className="lonyo-rating-wrap" data-aos="fade-up" data-aos-duration="900">
                ...
                <div className="lonyo-rating-content">
                  <p>
                    ““Great for tracking and organizing finances! I can see all my expenses in one place and set limits.
                    It helped me avoid overspending.”
                  </p>
