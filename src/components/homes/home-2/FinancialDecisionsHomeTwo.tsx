...
const FinancialDecisionsHomeTwo = ({ style_2, style_3 }: any) => {
  ...
  return (
    <>
      <section
        className={`${style_2 ? 'lonyo-section-padding' : style_3 ? 'lonyo-section-padding7' : 'lonyo-section-padding5'} `}>
          ...
          <div className="row">
            ...
            <div className="col-lg-7 d-flex align-items-center">
              <div className="lonyo-default-content pl-50" data-aos="fade-up" data-aos-duration="500">
                ...
                <p className="data">
                  With this tool, you can say goodbye to overspending, stay on track with your savings goals, and say
                  goodbye to financial worries. Get ready for a clearer view of your finances like never before!
                </p>
                <div className="mt-50">
