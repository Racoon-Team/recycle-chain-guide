            ...
            <div className="row">
              ...
              <div className="col-xl-4 col-lg-4 d-flex align-items-center justify-content-end">
                <div className="lonyo-title-btn">
                  <Link className="lonyo-default-btn t-btn" to="/contact-us">
        ...
        <Slider {...setting} className="lonyo-testimonial-slider-init">
          <div className="lonyo-t-wrap wrap2 light-bg">
            ...
            <div className="lonyo-t-text">
              <p>
                "This app transformed my budgeting! It has been a clear view longer have to worry of my It has been
                success expenses and savings goals."
              </p>
            </div>
          ...
          <div className="lonyo-t-wrap wrap2 light-bg">
            ...
            <div className="lonyo-t-text">
              <p>
                “The interface is intuitive, and I love how syncs with my bank accounts. I no longer have to worry about
                manual tracking. Highly recommend!”
              </p>
            </div>
            <div className="lonyo-t-author">
              <div className="lonyo-t-author-thumb">
          ...
          <div className="lonyo-t-wrap wrap2 light-bg">
            ...
            <div className="lonyo-t-text">
              <p>
                “With this app, I’ve been able to stick to my budget and even save for a vacation.The budget alerts are
                a game changer!”
              </p>
            </div>
            <div className="lonyo-t-author">
          ...
          <div className="lonyo-t-wrap wrap2 light-bg">
            ...
            <div className="lonyo-t-text">
              <p>
                "Having all my accounts in one place gives me complete overspending accounts control over my money.
                Highly recommend!"
              </p>
            </div>
            <div className="lonyo-t-author">
          ...
          <div className="lonyo-t-wrap wrap2 light-bg">
            ...
            <div className="lonyo-t-text">
              <p>
                "Having all my accounts in one place gives me complete control over my money. So user-friendly and
          ...
          <div className="lonyo-t-wrap wrap2 light-bg">
            ...
            <div className="lonyo-t-text">
              <p>
                “I can see all my spending in one place and set limits. It’s really helped me avoid overspending and
                manage my bills on time.”
              </p>
            </div>
            <div className="lonyo-t-author">
              <div className="lonyo-t-author-thumb">
          ...
          <div className="lonyo-t-wrap wrap2 light-bg">
            ...
            <div className="lonyo-t-text">
              <p>
                “I use it for my business accounting, expenses, It has been success and tax prep are all so easier. It
          ...
          <div className="lonyo-t-wrap wrap2 light-bg">
            ...
            <div className="lonyo-t-text">
              <p>
                "I love how easy it is to track my spending. It has been success It has been success The real-time
                updates keep me on top of my finances."
              </p>
            </div>
            <div className="lonyo-t-author">
              <div className="lonyo-t-author-thumb">
          ...
          <div className="lonyo-t-wrap wrap2 light-bg">
            ...
            <div className="lonyo-t-text">
              <p>
                “This app has completely transformed how I manage my money. I can goals easily. It’s like having a
                personal finance manager in my pocket!”
              </p>
            </div>
            <div className="lonyo-t-author">
              <div className="lonyo-t-author-thumb">
