...
const FooterOne = ({ style_2, style_3 }: any) => {
  return (
    <>
      <footer className={`lonyo-footer-section ${style_2 ? 'section2 bg-heading' : style_3 ? '' : 'light-bg'}`}>
        <div className="container">
          <div className="lonyo-footer-one">
            <div className="row">
              <div className="col-xxl-4 col-xl-12 col-md-6">
                <div className={`lonyo-footer-textarea ${style_2 ? 'textarea2' : ''}`}>
                  <Link to="/">
                    {style_2 ? (
                  ...
                  <div className="lonyo-footer-menu-wrap">
                    ...
                    <div className="lonyo-footer-menu1">
                      <ul>
                        ...
                        <li>
                          <Link to="/single-integration">Integration single</Link>
                        </li>
                        <li>
              ...
              <div className="col-xxl-2 col-xl-4 col-md-6">
                <div className={`lonyo-footer-menu pl-30 ${style_2 ? 'menu2' : ''}`}>
                  <h4>Utility pages</h4>
                  <ul>
                    <li>
                    ...
                    <li>
                      <Link to="/cooming-soon">Coming soon</Link>
                    </li>
                    <li>
              ...
              <div className="col-xxl-3 col-xl-4 col-md-6">
                <div className={`lonyo-footer-menu pl-31 mb-0 ${style_2 ? 'menu2' : ''}`}>
                  <h4>Join our newsletter</h4>
                  <div className={`${style_2 ? 'lonyo-subscription-field3' : 'lonyo-subscription-field2'}`}>
                    <form onSubmit={(e) => e.preventDefault()}>
                      <input type="email" placeholder="Enter your e-mail" />
                      <button
                        className={`lonyo-default-btn d-block ${style_2 ? 'subscrib-btn2' : 'subscrib-btn'}`}
                        type="submit">
                        Subscribe
                      </button>
                    </form>
            ...
            <div className={`${style_2 ? 'lonyo-footer-shape2' : 'lonyo-footer-shape'}`}></div>
          </div>
          <div className={`lonyo-footer-bottom-text ${style_2 ? 'text2' : ''}`}>
            <p>
              © Copyright <span id="current-year">{new Date().getFullYear()}</span>, All Rights Reserved by Mthemeus
            </p>
          </div>
        </div>
      </footer>
